...
| `haiqu.entangled_manifold_embedding()` | Data Encoding | [haiqu_EME.ipynb](sdk-tutorials/EME/haiqu_EME.ipynb) | Encode classical feature vectors into quantum states using Entangled Manifold Embedding (EME). 1000 features can fit in 100 qubits or fewer, controlled via a `density` parameter. |
